...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">UGANDA MARTYRS UNIVERSITY TIME TABLE MANAGEMENT SYSTEM</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/umu 2.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/rs.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/lib.jpg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/logo.gif" alt="Flower">
        </div>
    </div>
</div>
    ...
    <div class="container set-pad">
        <div class="row text-center">
            <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                <h1 data-scroll-reveal="enter from the bottom after 0.1s" class="header-line">SCIENCE FACULTY </h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Fr. KIWANUKA HENRY</h3>
                    <hr/>
                    <h4 align="center">Dean<br/>Faculty of Science</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Ms. LILIAN OGEN</h3>
                    <hr/>
                    <h4 align="center">ASSISTANT<br/> DEAN</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Mr. KASOZI BRIAN</h3>
                    <hr/>
                    <h4 align="center">HEAD OF DEPARTMENT<br/>Computer Science Department</h4>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4> Said UMU</h4>
                <h4><strong>Call:</strong>0331257534 </h4>
                <h4><strong>Email: </strong>scifaculty@umu.ac.ug.com</h4>
            </div>
